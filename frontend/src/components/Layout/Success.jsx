    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md text-center">
                ...
                <p className="text-gray-700 mb-4">Thank you for your payment of <strong>৳{amount}</strong> for the <strong>{pkg.name}</strong> package. Your transaction was successful.</p>
                <button
