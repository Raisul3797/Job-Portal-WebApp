...
function compose() {
  ...
  var fn = function fn2(props) {
    return styles6.reduce(function(acc, style2) {
  ...
  fn.propTypes = true ? styles6.reduce(function(acc, style2) {
    return _extends(acc, style2.propTypes);
  }, {}) : {};
  fn.filterProps = styles6.reduce(function(acc, style2) {
...
var useEnhancedEffect2 = typeof window === "undefined" ? React13.useEffect : React13.useLayoutEffect;
...
var Button = React16.forwardRef(function Button2(props, ref) {
  ...
  var startIcon = startIconProp && React16.createElement("span", {
    className: clsx_m_default(classes.startIcon, classes["iconSize".concat(capitalize(size))])
  }, startIconProp);
  var endIcon = endIconProp && React16.createElement("span", {
...
@material-ui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-E5B4ZDRF.js.map
